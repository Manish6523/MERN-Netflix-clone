...
const WatchPage = () => {
	...
	useEffect(() => {
		const getContentDetails = async () => {
			try {
				const res = await axios.get(`${host}/api/v1/${contentType}/${id}/details`,{Headers:"Access-Control-Allow-Origin: *"},{withCredentials:true});
	...
	return (
		<div className='bg-black min-h-screen text-white'>
			<div className='mx-auto container px-4 py-0 h-full'>
				<Navbar />
				...
				>
					...
					<img
						src={LARGE_IMAGE_PATH + content?.poster_path}
						alt='Poster image'
							...
							{similarContent.map((content) => {
								...
								return (
									<Link key={content.id} to={`/watch/${content.id}`} className='w-52 flex-none'>
										<img
											src={SMALL_IMAGE_PATH + content.poster_path}
											alt='Poster path'
